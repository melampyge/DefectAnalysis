...
def main():
    ...
    for step in range(args.inittime, args.fintime):
        ...
        ### calculate the bond orientations for plotting purposes
        ...
        sfilepath = args.figfolder + 'defect_pts_orient_' + str(step) + '.png'
#        plot_defects.pretty_plot(beads.x[step, 0, :], beads.x[step, 1, :], beads.cid, \
#                                 xd, yd, tail, dmax, cell_list, sim, sfilepath)
        plot_defects.pretty_plot(beads.x[step, 0, :], beads.x[step, 1, :], phi, \
                                 xd, yd, tail, dmax, cell_list, sim, sfilepath)
